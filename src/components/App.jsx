// import CounterReviews  from "./CounterReviews/counterReviews";
...
export class App extends React.Component{
  ...
  handleIncrement = (e) => {
    const {countTotalFeedback,countPositiveFeedbackPercentage} = this;
      ...
      this.setState(prevState=>{return {[reviewsName] : (prevState[reviewsName]+1)}});
      countTotalFeedback();
  ...
  render(){
    const {good,neutral,bad} = this.state;
    const {handleIncrement,countTotalFeedback,countPositiveFeedbackPercentage,isViews} = this;
      return (
    <div
        style={{
          height: '100vh',
